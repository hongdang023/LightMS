...
export const ONBOARDING_DAYS_DATA: OnboardingDay[] = [
  ...
  },
  {
    ...
    bonusResources: "- [Software architecture for non-technical builders](https://blog.ravi-mehta.com/p/software-architecture?r=2f46k&utm_medium=ios&triedRedirect=true)\n- [Tina Huang - Google Firebase Studio In 23 Minutes](https://youtu.be/Rd6F5wHIysM?si=2dwAHz2nHDUjmIFM)\n- [Supabase - Getting Started with Supabase](https://youtu.be/i_bPeTZVlg0?si=JANCBlxJsJm47l9D)\n- [Supabase - How to Use Supabase with n8n (Database + File Storage)](https://youtu.be/YR30uzwWoDM?si=Jl0n1iFI5NW1TJj2)\n- [Plytix - How To Create a Database in Google Sheets](https://youtu.be/bKJdWKm4aik?si=Fn81KFGLuciwDlSK)"
  },
  {
    day: 7,
