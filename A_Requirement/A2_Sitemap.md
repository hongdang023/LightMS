...
- **Thông báo** (Icon: Megaphone / Loa truyền tin)
  - Nơi upload các tin mới nhất của lớp. Lúc ấn vào từng thông báo thì sẽ được điều hướng để đọc cả bài.

- **About** (Icon: Logbook / Nhật ký hải trình)
...
- **Syllabus** (Icon: Scroll Map / Bản đồ cuộn)
...
- **Discussions** (Icon: Tavern Banner / Lá cờ hội quán)
...
- **Leaderboard** (Icon: Nautical Star / Sao hàng hải 8 cánh)
  - Khu vực ghi nhận kết quả tốt và thành tựu xuất sắc của học viên. _(US-STU-09)_

- **Support** (Icon: Lifebuoy / Phao cứu sinh)
  - Cung cấp danh sách FAQ. Kèm theo button dẫn link trực tiếp vào phòng Light Support trên Telegram. (US-STU-05)
...
- **System Overview** (Icon: Grid Dashboard)
  - **System Overview:** Hiển thị các hoạt động đang diễn ra cùng lúc để kiểm soát tránh quá tải. _(US-AD-06)_
  - **Risk Alerts:** Danh sách học viên học chậm, có nguy cơ bỏ học để can thiệp kịp thời. _(US-AD-01)_
...
- **Course Builder** (Icon: Plan Rules / Thước kẻ)
  - Cấu hình nội dung cho các trang About, Onboarding, Syllabus (module/bài học/bài tập). Tích hợp chế độ **Reading Mode / Editing Mode với giao diện y hệt Student Mode** để Admin có thể xem trước và điều chỉnh các chi tiết nhỏ dễ dàng hơn. _(US-AD-13)_
...
- **Calendar** (Icon: Astrolabe / Dụng cụ đo tinh tú)
  - Chỉnh sửa lịch trình khóa học cho các sự kiện/cụm hoạt động (Kick-off, Live Class, Office Hour, Onboarding). _(US-AD-14)_

- **SpeedGrader** (Icon: Checkbox Sheet)
  - Nơi Mentor theo dõi tiến độ nộp bài, chấm điểm bằng Rich-text và đánh giá mức độ Mastery cho từng học viên.

- **Students** (Icon: Crew Silhouette)
