...
- **US-AD-01**: Là một admin, tôi muốn biết ai đang học tốt, ai chậm tiến độ và ai có nguy cơ bỏ học, để can thiệp đúng lúc. _(Từ JTBD #1)_
- **US-AD-02**: Là một admin, tôi muốn tự động hóa các tác vụ lặp lại (quản lý lịch học, thông báo, bài tập, học liệu), để dành thời gian cho những hoạt động tạo giá trị cao hơn. _(Từ JTBD #2)_
- **US-AD-03**: Là một admin, tôi muốn có một hệ thống tập trung để quản lý toàn bộ recording, study notes và tài nguyên học tập, để giảm thất lạc thông tin. _(Từ JTBD #3)_
...
- **US-AD-05**: Là một admin, tôi muốn hệ thống vận hành trơn tru khi scale số lượng học viên, để không phải tăng tương ứng số lượng nhân sự vận hành. _(Từ JTBD #5)_
- **US-AD-12**: Là một admin, tôi muốn có mục Thông báo để viết bài cập nhật (tự động đồng bộ sang NavItem của học viên) và có button gửi email cho toàn bộ học viên, để truyền đạt thông tin quan trọng nhanh chóng.
- **US-AD-13**: Là một admin, tôi muốn có tính năng Edit Mode/Reading Mode với giao diện y hệt của Học viên (Student Mode) cho mục Giới thiệu, Onboarding, Lộ trình học, để dễ dàng xem trước và điều chỉnh các chi tiết nhỏ.
- **US-AD-14**: Là một admin, tôi muốn có mục Calendar (Lịch học) trên Sidebar để dễ dàng chỉnh sửa lịch trình khoá học cho các sự kiện (Kick-off, Live Class, Office Hour, Onboarding).

### Emotional Stories

- **US-AD-06**: Là một admin, tôi muốn có một dashboard tổng quan hiển thị các hoạt động diễn ra cùng lúc, để kiểm soát hệ thống, không bị quá tải hoặc bỏ sót việc quan trọng. _(Từ JTBD #6)_
...
- **US-AD-09**: Là một admin, tôi muốn hệ thống giúp ghi nhận và lan tỏa những thành tựu của học viên, để tạo ra các câu chuyện thành công và động lực cho toàn cộng đồng. _(Từ JTBD #9)_
